...
class henon_radial(object):
    def __init__(self, n_theta, n_steps, epsilon):
        ...
        self.engine = gpu_hm.gpu_henon_radial(n_theta, n_steps, epsilon)
...
class henon_grid(object):
    def __init__(self, n_x, n_y, epsilon):
        ...
        self.engine = gpu_hm.gpu_henon_grid(n_x, n_y, epsilon)
        self.times = np.array(self.engine.compute(0, 1))
...
class henon_scan(object):
    def __init__(self, x0, y0, px0, py0, epsilon):
        ...
        self.engine = gpu_hm.gpu_henon_scan(x0, y0, px0, py0, epsilon)
...
class henon_track(object):
    def __init__(self, x0, y0, px0, py0, epsilon):
        ...
        self.engine = gpu_hm.gpu_henon_track(x0, y0, px0, py0, epsilon)
        self.times = 0
...
class radial_scan(object):
    def __init__(self, dr, alpha, theta1, theta2, epsilon, omx=0.168, omy=0.201):
        ...
        self.engine = gpu_hm.gpu_radial_scan(
